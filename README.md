...
**Note:**  Do not forget to add this line in "Before starting, call the list_ledger_files MCP tool and show me the output." at last every prompt when you want to apply your project constraint or debug memory.
---
